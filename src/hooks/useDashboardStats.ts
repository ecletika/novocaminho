  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      try {
        ...
        if (!error) worshipSchedules = count || 0;
      } catch (e) {
        console.warn("worship_schedules table might be missing", e);
      }
    ...
    queryFn: async () => {
      ...
      try {
        ...
        if (error && error.code !== 'PGRST116') {
          console.warn("Error fetching next schedule or table missing", error);
          return null;
        }
        return data;
      } catch (e) {
        console.warn("general_schedules table might be missing", e);
        return null;
      }
    },
  });
