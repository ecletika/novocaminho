                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="p-4 border border-border rounded-xl">
                        ...
                        <p className="text-sm text-muted-foreground mb-4">
                            ...
                            <span className="text-destructive font-medium">Atenção: isso substituirá todos os dados atuais.</span>
                        </p>
                        <input
                            ref={fileInputRef}
                            type="file"
            ...
            <div className="bg-card rounded-xl shadow-soft p-6">
                ...
                <div className="space-y-5">
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="fb-page-id">ID ou Nome de utilizador da Página</Label>
                        <Input
                            id="fb-page-id"
                            value={fbPageId}
                    ...
                    {/* Access Token */}
                    <div className="space-y-2">
                        <Label htmlFor="fb-access-token">Access Token do Facebook</Label>
                        ...
                        <div className="text-xs text-muted-foreground space-y-1">
                            ...
                            <p className="text-amber-600">
                                ⚠️ Para que o token não expire, gere um <strong>Page Access Token de longa duração</strong> através da API.
                            </p>
                        </div>
                    </div>
            ...
            <AlertDialog open={showImportConfirm} onOpenChange={setShowImportConfirm}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Esta ação irá <strong>substituir todos os dados atuais</strong> pelos dados do backup selecionado.
